 ...
 */
 function loadImages(nPairs, nImageMode, nScoreMode)
 {
   ...
   if(document.images)
   {
     imgBackside.src  = IMG_PATH + "cardfrente.png";
     
     // Load start and stop button
     for(var i = 0; i < 4; i++)
     {
       imgArrStartStop[i] = new Image();
       imgArrStartStop[i].src = IMG_PATH + "startstop" + (i + 1) + ".png";
     }
     ...
     for(var i = 0; i < nImages; i++)
     {
       if(IMG_MODE == 1)
       {
         ...
         imgArrField[i * 2].src = IMG_PATH + "pic" + (i + 1) + "a.png";
         imgArrField[i * 2 + 1] = new Image();
         imgArrField[i * 2 + 1].src = IMG_PATH + "pic" + (i + 1) + "b.png";
       }
       else
       {
         IMG_MODE = 0;
         imgArrField[i * 2] = new Image();
         imgArrField[i * 2].src = IMG_PATH + "pic" + (i + 1) + ".png";
         imgArrField[i * 2 + 1] = new Image();
         imgArrField[i * 2 + 1].src = IMG_PATH + "pic" + (i + 1) + ".png";
       }
     }
 ...
 function showCard(nImage)
 {
   if(document.images)
   {
       ...
       if(nSelected1 != -1 && nSelected2 != -1)
       {
         ...
         if(pic1.substr(0, len1 - IMG_MODE - 4) == pic2.substr(0, len2 - IMG_MODE - 4))
         {
           ...
           if(nHit == nImages)
           {
             ...
             strMsg = "Você fez " + nPoints + " pontos.\nPor favor, insira seu nome :";
             ...
             if(strName != null && strName != "")
             {
               ...
               if(nHighscoreMode == 1)
               {
                  strURL = "show_score.php" + "/" + nPoints + "/" + escape(strPlayerName) + "/" + escape(strDate) + "/" + nLevel + "/" + nSeconds + "/" + nAttempts;
     ...
     else
     {
       if(!bRunning)
       {
         alert("Por Favor clique no botão de Início !");
       }
     }
   }
 }
